    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-700 to-indigo-800 text-white font-mono">
      ...
      <main className="relative">
        <div className="z-50 max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <ReactMarkdown 
            components={{
              h1: ({node, ...props}) => <h1 className="text-4xl font-extrabold text-cyan-300 mb-4 shadow-neon-cyan" {...props} />,
              h2: ({node, ...props}) => <h2 className="text-3xl font-bold text-pink-300 mb-3 shadow-neon-pink" {...props} />,
              p: ({node, ...props}) => <p className="text-lg text-indigo-200 mb-4 shadow-neon-indigo" {...props} />,
        ...
        <div className="z-10 absolute top-1/2 left-1/4 w-64 h-64 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob pointer-events-none"></div>
        <div className="z-10 absolute top-1/3 right-1/4 w-64 h-64 bg-cyan-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000 pointer-events-none"></div>
        <div className="z-10 absolute bottom-1/2 left-1/2 w-64 h-64 bg-yellow-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000 pointer-events-none"></div>
      </main>
      {currentLesson.lessonQuiz && (
        <QuizPanel 
          isOpen={isQuizOpen} 
